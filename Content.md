...
<p class="tip">
If you just want to start modifying the application, you just need to perform the first step above. You can then start modifying the application using Unity.
 </p>
